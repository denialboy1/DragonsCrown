...
{
	alphaImage* img;
	arrEffectsAlpha vEffectBuffer; //이펙트 버퍼
	arrEffectAlpha mArrEffect;	  //키 값과 이펙트 버퍼 담아줄 맵
...
{
	pngImage* img;
	arrPngEffects vEffectBuffer; //이펙트 버퍼
	arrPngEffect mArrEffect;	  //키 값과 이펙트 버퍼 담아줄 맵
