	...
	int x, int y, int width, int height)
{
	...
	_progressBarBack = IMAGEMANAGER->addImage(btnDownImageKeyName, strDownName, x, y, width, height, true, RGB(255, 0, 255), true);
	_progressBarForward = IMAGEMANAGER->addImage(btnUpImageKeyName, strUpName, x, y, width, height, true, RGB(255, 0, 255), true);
